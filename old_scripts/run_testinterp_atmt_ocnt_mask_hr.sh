...
## - Define paths
srcdir=`pwd`
datadir=$srcdir/data_oasis3_arome_nemo_mask_hr
...
rundir=$srcdir/${casename}_${SRC_GRID}_${TGT_GRID}_${remap}_mask_hr/rundir_${nnode}_${mpiprocs}_${threads}
...
module load netcdf-c/4.7.1
module load netcdf-fortran/4.5.2

export NETCDF_CONFIG=$NETCDFF_BIN/nf-config
export OASISDIR=${HOME}/SAVE/oasis3-mct_4.0/BELENOS_oa3-mct
